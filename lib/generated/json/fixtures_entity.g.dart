...
FixturesEntity $FixturesEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<FixturesData>? data =
      jsonConvert.convertListNotNull<FixturesData>(json['data']);
  if (data != null) {
    fixturesEntity.data = data;
  }
  final FixturesLinks? links =
      jsonConvert.convert<FixturesLinks>(json['links']);
  if (links != null) {
...
FixturesData $FixturesDataFromJson(Map<String, dynamic> json) {
  ...
  final String? drawNoresult =
      jsonConvert.convert<String>(json['draw_noresult']);
  ...
  final int? secondUmpireId =
      jsonConvert.convert<int>(json['second_umpire_id']);
  ...
  final int? totalOversPlayed =
      jsonConvert.convert<int>(json['total_overs_played']);
  ...
  final FixturesDataLocalteamDlData? localteamDlData = jsonConvert
      .convert<FixturesDataLocalteamDlData>(json['localteam_dl_data']);
  if (localteamDlData != null) {
    fixturesData.localteamDlData = localteamDlData;
  }
  final FixturesDataVisitorteamDlData? visitorteamDlData = jsonConvert
      .convert<FixturesDataVisitorteamDlData>(json['visitorteam_dl_data']);
  if (visitorteamDlData != null) {
    fixturesData.visitorteamDlData = visitorteamDlData;
  }
  final String? rpcOvers = jsonConvert.convert<String>(json['rpc_overs']);
  if (rpcOvers != null) {
    fixturesData.rpcOvers = rpcOvers;
  }
  final String? rpcTarget = jsonConvert.convert<String>(json['rpc_target']);
  if (rpcTarget != null) {
    fixturesData.rpcTarget = rpcTarget;
  }
  final List<dynamic>? weatherReport =
      jsonConvert.convertListNotNull<dynamic>(json['weather_report']);
  if (weatherReport != null) {
    fixturesData.weatherReport = weatherReport;
  }
  final FixturesDataLeague? league =
      jsonConvert.convert<FixturesDataLeague>(json['league']);
  if (league != null) {
    fixturesData.league = league;
  }
  final FixturesDataSeason? season =
      jsonConvert.convert<FixturesDataSeason>(json['season']);
  if (season != null) {
    fixturesData.season = season;
  }
  final FixturesDataLocalteam? localteam =
      jsonConvert.convert<FixturesDataLocalteam>(json['localteam']);
  if (localteam != null) {
    fixturesData.localteam = localteam;
  }
  final FixturesDataVisitorteam? visitorteam =
      jsonConvert.convert<FixturesDataVisitorteam>(json['visitorteam']);
  if (visitorteam != null) {
    fixturesData.visitorteam = visitorteam;
  }
  final List<FixturesDataBatting>? batting =
      jsonConvert.convertListNotNull<FixturesDataBatting>(json['batting']);
  if (batting != null) {
    fixturesData.batting = batting;
  }
  final List<FixturesDataBowling>? bowling =
      jsonConvert.convertListNotNull<FixturesDataBowling>(json['bowling']);
  if (bowling != null) {
    fixturesData.bowling = bowling;
  }
  final List<FixturesDataRuns>? runs =
      jsonConvert.convertListNotNull<FixturesDataRuns>(json['runs']);
  if (runs != null) {
    fixturesData.runs = runs;
  }
  final List<FixturesDataScoreboards>? scoreboards = jsonConvert
      .convertListNotNull<FixturesDataScoreboards>(json['scoreboards']);
  if (scoreboards != null) {
    fixturesData.scoreboards = scoreboards;
  }
  final List<FixturesDataLineup>? lineup =
      jsonConvert.convertListNotNull<FixturesDataLineup>(json['lineup']);
  if (lineup != null) {
    fixturesData.lineup = lineup;
  }
  final FixturesDataManofmatch? manofmatch =
      jsonConvert.convert<FixturesDataManofmatch>(json['manofmatch']);
  if (manofmatch != null) {
    fixturesData.manofmatch = manofmatch;
  }
  final FixturesDataManofseries? manofseries =
      jsonConvert.convert<FixturesDataManofseries>(json['manofseries']);
  if (manofseries != null) {
    fixturesData.manofseries = manofseries;
  }
  final FixturesDataReferee? referee =
      jsonConvert.convert<FixturesDataReferee>(json['referee']);
  if (referee != null) {
    fixturesData.referee = referee;
  }
  final FixturesDataFirstumpire? firstumpire =
      jsonConvert.convert<FixturesDataFirstumpire>(json['firstumpire']);
  if (firstumpire != null) {
    fixturesData.firstumpire = firstumpire;
  }
  final FixturesDataSecondumpire? secondumpire =
      jsonConvert.convert<FixturesDataSecondumpire>(json['secondumpire']);
  if (secondumpire != null) {
    fixturesData.secondumpire = secondumpire;
  }
  final FixturesDataTvumpire? tvumpire =
      jsonConvert.convert<FixturesDataTvumpire>(json['tvumpire']);
  if (tvumpire != null) {
    fixturesData.tvumpire = tvumpire;
  }
  final FixturesDataWinnerteam? winnerteam =
      jsonConvert.convert<FixturesDataWinnerteam>(json['winnerteam']);
  if (winnerteam != null) {
    fixturesData.winnerteam = winnerteam;
  }
  final FixturesDataTosswon? tosswon =
      jsonConvert.convert<FixturesDataTosswon>(json['tosswon']);
  if (tosswon != null) {
    fixturesData.tosswon = tosswon;
  }
  final FixturesDataVenue? venue =
      jsonConvert.convert<FixturesDataVenue>(json['venue']);
  if (venue != null) {
...
Map<String, dynamic> $FixturesDataToJson(FixturesData entity) {
  ...
  data['season'] = entity.season?.toJson();
  ...
  data['scoreboards'] = entity.scoreboards?.map((v) => v.toJson()).toList();
  data['lineup'] = entity.lineup?.map((v) => v.toJson()).toList();
  data['manofmatch'] = entity.manofmatch?.toJson();
  data['manofseries'] = entity.manofseries?.toJson();
  data['referee'] = entity.referee?.toJson();
  data['firstumpire'] = entity.firstumpire?.toJson();
  data['secondumpire'] = entity.secondumpire?.toJson();
  data['tvumpire'] = entity.tvumpire?.toJson();
  data['winnerteam'] = entity.winnerteam?.toJson();
  data['tosswon'] = entity.tosswon?.toJson();
  data['venue'] = entity.venue?.toJson();
  return data;
}

FixturesDataLocalteamDlData $FixturesDataLocalteamDlDataFromJson(
    Map<String, dynamic> json) {
  final FixturesDataLocalteamDlData fixturesDataLocalteamDlData =
...
Map<String, dynamic> $FixturesDataLocalteamDlDataToJson(
    FixturesDataLocalteamDlData entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
FixturesDataVisitorteamDlData $FixturesDataVisitorteamDlDataFromJson(
    Map<String, dynamic> json) {
  final FixturesDataVisitorteamDlData fixturesDataVisitorteamDlData =
...
Map<String, dynamic> $FixturesDataVisitorteamDlDataToJson(
    FixturesDataVisitorteamDlData entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['score'] = entity.score;
  data['overs'] = entity.overs;
  data['wickets_out'] = entity.wicketsOut;
...
FixturesDataLeague $FixturesDataLeagueFromJson(Map<String, dynamic> json) {
  final FixturesDataLeague fixturesDataLeague = FixturesDataLeague();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataLeague.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataLeague.id = id;
  }
  final int? seasonId = jsonConvert.convert<int>(json['season_id']);
  if (seasonId != null) {
    fixturesDataLeague.seasonId = seasonId;
  }
  final int? countryId = jsonConvert.convert<int>(json['country_id']);
  if (countryId != null) {
    fixturesDataLeague.countryId = countryId;
  }
  final String? name = jsonConvert.convert<String>(json['name']);
  if (name != null) {
    fixturesDataLeague.name = name;
  }
  final String? code = jsonConvert.convert<String>(json['code']);
  if (code != null) {
    fixturesDataLeague.code = code;
  }
  final String? imagePath = jsonConvert.convert<String>(json['image_path']);
  if (imagePath != null) {
    fixturesDataLeague.imagePath = imagePath;
  }
  final String? type = jsonConvert.convert<String>(json['type']);
  if (type != null) {
    fixturesDataLeague.type = type;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataLeague.updatedAt = updatedAt;
  }
  return fixturesDataLeague;
}

Map<String, dynamic> $FixturesDataLeagueToJson(FixturesDataLeague entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['season_id'] = entity.seasonId;
...
FixturesDataSeason $FixturesDataSeasonFromJson(Map<String, dynamic> json) {
  final FixturesDataSeason fixturesDataSeason = FixturesDataSeason();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataSeason.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataSeason.id = id;
  }
  final int? leagueId = jsonConvert.convert<int>(json['league_id']);
  if (leagueId != null) {
    fixturesDataSeason.leagueId = leagueId;
  }
  final String? name = jsonConvert.convert<String>(json['name']);
  if (name != null) {
    fixturesDataSeason.name = name;
  }
  final String? code = jsonConvert.convert<String>(json['code']);
  if (code != null) {
    fixturesDataSeason.code = code;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataSeason.updatedAt = updatedAt;
  }
  return fixturesDataSeason;
}

Map<String, dynamic> $FixturesDataSeasonToJson(FixturesDataSeason entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['league_id'] = entity.leagueId;
...
FixturesDataLocalteam $FixturesDataLocalteamFromJson(
    Map<String, dynamic> json) {
...
Map<String, dynamic> $FixturesDataLocalteamToJson(
    FixturesDataLocalteam entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['name'] = entity.name;
...
FixturesDataVisitorteam $FixturesDataVisitorteamFromJson(
    Map<String, dynamic> json) {
  final FixturesDataVisitorteam fixturesDataVisitorteam =
...
Map<String, dynamic> $FixturesDataVisitorteamToJson(
    FixturesDataVisitorteam entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['name'] = entity.name;
...
FixturesDataBatting $FixturesDataBattingFromJson(Map<String, dynamic> json) {
  ...
  final int? catchStumpPlayerId =
      jsonConvert.convert<int>(json['catch_stump_player_id']);
  ...
  final dynamic batsmanoutId =
      jsonConvert.convert<dynamic>(json['batsmanout_id']);
  if (batsmanoutId != null) {
    fixturesDataBatting.batsmanoutId = batsmanoutId;
  }
  final int? bowlingPlayerId =
      jsonConvert.convert<int>(json['bowling_player_id']);
  ...
  final int? fowBalls = jsonConvert.convert<int>(json['fow_balls']);
  if (fowBalls != null) {
...
FixturesDataScoreboards $FixturesDataScoreboardsFromJson(
    Map<String, dynamic> json) {
  final FixturesDataScoreboards fixturesDataScoreboards =
      FixturesDataScoreboards();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataScoreboards.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataScoreboards.id = id;
  }
  final int? fixtureId = jsonConvert.convert<int>(json['fixture_id']);
  if (fixtureId != null) {
    fixturesDataScoreboards.fixtureId = fixtureId;
  }
  final int? teamId = jsonConvert.convert<int>(json['team_id']);
  if (teamId != null) {
    fixturesDataScoreboards.teamId = teamId;
  }
  final String? type = jsonConvert.convert<String>(json['type']);
  if (type != null) {
    fixturesDataScoreboards.type = type;
  }
  final String? scoreboard = jsonConvert.convert<String>(json['scoreboard']);
  if (scoreboard != null) {
    fixturesDataScoreboards.scoreboard = scoreboard;
  }
  final int? wide = jsonConvert.convert<int>(json['wide']);
  if (wide != null) {
    fixturesDataScoreboards.wide = wide;
  }
  final int? noballRuns = jsonConvert.convert<int>(json['noball_runs']);
  if (noballRuns != null) {
    fixturesDataScoreboards.noballRuns = noballRuns;
  }
  final int? noballBalls = jsonConvert.convert<int>(json['noball_balls']);
  if (noballBalls != null) {
    fixturesDataScoreboards.noballBalls = noballBalls;
  }
  final int? bye = jsonConvert.convert<int>(json['bye']);
  if (bye != null) {
    fixturesDataScoreboards.bye = bye;
  }
  final int? legBye = jsonConvert.convert<int>(json['leg_bye']);
  if (legBye != null) {
    fixturesDataScoreboards.legBye = legBye;
  }
  final int? penalty = jsonConvert.convert<int>(json['penalty']);
  if (penalty != null) {
    fixturesDataScoreboards.penalty = penalty;
  }
  final int? total = jsonConvert.convert<int>(json['total']);
  if (total != null) {
    fixturesDataScoreboards.total = total;
  }
  final int? overs = jsonConvert.convert<int>(json['overs']);
  if (overs != null) {
    fixturesDataScoreboards.overs = overs;
  }
  final int? wickets = jsonConvert.convert<int>(json['wickets']);
  if (wickets != null) {
    fixturesDataScoreboards.wickets = wickets;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataScoreboards.updatedAt = updatedAt;
  }
  return fixturesDataScoreboards;
}

Map<String, dynamic> $FixturesDataScoreboardsToJson(
    FixturesDataScoreboards entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['fixture_id'] = entity.fixtureId;
  ...
  data['scoreboard'] = entity.scoreboard;
  data['wide'] = entity.wide;
  data['noball_runs'] = entity.noballRuns;
  data['noball_balls'] = entity.noballBalls;
  data['bye'] = entity.bye;
  data['leg_bye'] = entity.legBye;
...
FixturesDataLineup $FixturesDataLineupFromJson(Map<String, dynamic> json) {
  ...
  final FixturesDataLineupPosition? position =
      jsonConvert.convert<FixturesDataLineupPosition>(json['position']);
  if (position != null) {
  ...
  final FixturesDataLineupLineup? lineup =
      jsonConvert.convert<FixturesDataLineupLineup>(json['lineup']);
  if (lineup != null) {
...
FixturesDataLineupPosition $FixturesDataLineupPositionFromJson(
    Map<String, dynamic> json) {
  final FixturesDataLineupPosition fixturesDataLineupPosition =
...
Map<String, dynamic> $FixturesDataLineupPositionToJson(
    FixturesDataLineupPosition entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['name'] = entity.name;
...
FixturesDataLineupLineup $FixturesDataLineupLineupFromJson(
    Map<String, dynamic> json) {
  final FixturesDataLineupLineup fixturesDataLineupLineup =
...
Map<String, dynamic> $FixturesDataLineupLineupToJson(
    FixturesDataLineupLineup entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['team_id'] = entity.teamId;
...
FixturesDataManofmatch $FixturesDataManofmatchFromJson(
    Map<String, dynamic> json) {
  final FixturesDataManofmatch fixturesDataManofmatch =
...
Map<String, dynamic> $FixturesDataManofmatchToJson(
    FixturesDataManofmatch entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['country_id'] = entity.countryId;
...
FixturesDataManofmatchPosition $FixturesDataManofmatchPositionFromJson(
    Map<String, dynamic> json) {
  final FixturesDataManofmatchPosition fixturesDataManofmatchPosition =
...
Map<String, dynamic> $FixturesDataManofmatchPositionToJson(
    FixturesDataManofmatchPosition entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['name'] = entity.name;
...
FixturesDataManofseries $FixturesDataManofseriesFromJson(
    Map<String, dynamic> json) {
  final FixturesDataManofseries fixturesDataManofseries =
      FixturesDataManofseries();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataManofseries.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataManofseries.id = id;
  }
  final int? countryId = jsonConvert.convert<int>(json['country_id']);
  if (countryId != null) {
    fixturesDataManofseries.countryId = countryId;
  }
  final String? firstname = jsonConvert.convert<String>(json['firstname']);
  if (firstname != null) {
    fixturesDataManofseries.firstname = firstname;
  }
  final String? lastname = jsonConvert.convert<String>(json['lastname']);
  if (lastname != null) {
    fixturesDataManofseries.lastname = lastname;
  }
  final String? fullname = jsonConvert.convert<String>(json['fullname']);
  if (fullname != null) {
    fixturesDataManofseries.fullname = fullname;
  }
  final String? imagePath = jsonConvert.convert<String>(json['image_path']);
  if (imagePath != null) {
    fixturesDataManofseries.imagePath = imagePath;
  }
  final String? dateofbirth = jsonConvert.convert<String>(json['dateofbirth']);
  if (dateofbirth != null) {
    fixturesDataManofseries.dateofbirth = dateofbirth;
  }
  final String? gender = jsonConvert.convert<String>(json['gender']);
  if (gender != null) {
    fixturesDataManofseries.gender = gender;
  }
  final String? battingstyle =
      jsonConvert.convert<String>(json['battingstyle']);
  if (battingstyle != null) {
  ...
  if (position != null) {
    fixturesDataManofseries.position = position;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataManofseries.updatedAt = updatedAt;
  }
  return fixturesDataManofseries;
}

Map<String, dynamic> $FixturesDataManofseriesToJson(
    FixturesDataManofseries entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['country_id'] = entity.countryId;
...
FixturesDataManofseriesPosition $FixturesDataManofseriesPositionFromJson(
    Map<String, dynamic> json) {
  final FixturesDataManofseriesPosition fixturesDataManofseriesPosition =
      FixturesDataManofseriesPosition();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataManofseriesPosition.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataManofseriesPosition.id = id;
  }
  final String? name = jsonConvert.convert<String>(json['name']);
  if (name != null) {
    fixturesDataManofseriesPosition.name = name;
  }
  return fixturesDataManofseriesPosition;
}

Map<String, dynamic> $FixturesDataManofseriesPositionToJson(
    FixturesDataManofseriesPosition entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['name'] = entity.name;
...
FixturesDataReferee $FixturesDataRefereeFromJson(Map<String, dynamic> json) {
  final FixturesDataReferee fixturesDataReferee = FixturesDataReferee();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataReferee.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataReferee.id = id;
  }
  final int? countryId = jsonConvert.convert<int>(json['country_id']);
  if (countryId != null) {
    fixturesDataReferee.countryId = countryId;
  }
  final String? firstname = jsonConvert.convert<String>(json['firstname']);
  if (firstname != null) {
    fixturesDataReferee.firstname = firstname;
  }
  final String? lastname = jsonConvert.convert<String>(json['lastname']);
  if (lastname != null) {
    fixturesDataReferee.lastname = lastname;
  }
  final String? fullname = jsonConvert.convert<String>(json['fullname']);
  if (fullname != null) {
    fixturesDataReferee.fullname = fullname;
  }
  final String? dateofbirth = jsonConvert.convert<String>(json['dateofbirth']);
  if (dateofbirth != null) {
    fixturesDataReferee.dateofbirth = dateofbirth;
  }
  final String? gender = jsonConvert.convert<String>(json['gender']);
  if (gender != null) {
    fixturesDataReferee.gender = gender;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataReferee.updatedAt = updatedAt;
  }
  return fixturesDataReferee;
}

Map<String, dynamic> $FixturesDataRefereeToJson(FixturesDataReferee entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['country_id'] = entity.countryId;
...
FixturesDataFirstumpire $FixturesDataFirstumpireFromJson(
    Map<String, dynamic> json) {
  final FixturesDataFirstumpire fixturesDataFirstumpire =
      FixturesDataFirstumpire();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataFirstumpire.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataFirstumpire.id = id;
  }
  final int? countryId = jsonConvert.convert<int>(json['country_id']);
  if (countryId != null) {
    fixturesDataFirstumpire.countryId = countryId;
  }
  final String? firstname = jsonConvert.convert<String>(json['firstname']);
  if (firstname != null) {
    fixturesDataFirstumpire.firstname = firstname;
  }
  final String? lastname = jsonConvert.convert<String>(json['lastname']);
  if (lastname != null) {
    fixturesDataFirstumpire.lastname = lastname;
  }
  final String? fullname = jsonConvert.convert<String>(json['fullname']);
  if (fullname != null) {
    fixturesDataFirstumpire.fullname = fullname;
  }
  final String? dateofbirth = jsonConvert.convert<String>(json['dateofbirth']);
  if (dateofbirth != null) {
    fixturesDataFirstumpire.dateofbirth = dateofbirth;
  }
  final String? gender = jsonConvert.convert<String>(json['gender']);
  if (gender != null) {
    fixturesDataFirstumpire.gender = gender;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataFirstumpire.updatedAt = updatedAt;
  }
  return fixturesDataFirstumpire;
}

Map<String, dynamic> $FixturesDataFirstumpireToJson(
    FixturesDataFirstumpire entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['country_id'] = entity.countryId;
...
FixturesDataSecondumpire $FixturesDataSecondumpireFromJson(
    Map<String, dynamic> json) {
  final FixturesDataSecondumpire fixturesDataSecondumpire =
      FixturesDataSecondumpire();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataSecondumpire.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataSecondumpire.id = id;
  }
  final int? countryId = jsonConvert.convert<int>(json['country_id']);
  if (countryId != null) {
    fixturesDataSecondumpire.countryId = countryId;
  }
  final String? firstname = jsonConvert.convert<String>(json['firstname']);
  if (firstname != null) {
    fixturesDataSecondumpire.firstname = firstname;
  }
  final String? lastname = jsonConvert.convert<String>(json['lastname']);
  if (lastname != null) {
    fixturesDataSecondumpire.lastname = lastname;
  }
  final String? fullname = jsonConvert.convert<String>(json['fullname']);
  if (fullname != null) {
    fixturesDataSecondumpire.fullname = fullname;
  }
  final String? dateofbirth = jsonConvert.convert<String>(json['dateofbirth']);
  if (dateofbirth != null) {
    fixturesDataSecondumpire.dateofbirth = dateofbirth;
  }
  final String? gender = jsonConvert.convert<String>(json['gender']);
  if (gender != null) {
    fixturesDataSecondumpire.gender = gender;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataSecondumpire.updatedAt = updatedAt;
  }
  return fixturesDataSecondumpire;
}

Map<String, dynamic> $FixturesDataSecondumpireToJson(
    FixturesDataSecondumpire entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['country_id'] = entity.countryId;
...
FixturesDataTvumpire $FixturesDataTvumpireFromJson(Map<String, dynamic> json) {
  final FixturesDataTvumpire fixturesDataTvumpire = FixturesDataTvumpire();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataTvumpire.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataTvumpire.id = id;
  }
  final int? countryId = jsonConvert.convert<int>(json['country_id']);
  if (countryId != null) {
    fixturesDataTvumpire.countryId = countryId;
  }
  final String? firstname = jsonConvert.convert<String>(json['firstname']);
  if (firstname != null) {
    fixturesDataTvumpire.firstname = firstname;
  }
  final String? lastname = jsonConvert.convert<String>(json['lastname']);
  if (lastname != null) {
    fixturesDataTvumpire.lastname = lastname;
  }
  final String? fullname = jsonConvert.convert<String>(json['fullname']);
  if (fullname != null) {
    fixturesDataTvumpire.fullname = fullname;
  }
  final String? dateofbirth = jsonConvert.convert<String>(json['dateofbirth']);
  if (dateofbirth != null) {
    fixturesDataTvumpire.dateofbirth = dateofbirth;
  }
  final String? gender = jsonConvert.convert<String>(json['gender']);
  if (gender != null) {
    fixturesDataTvumpire.gender = gender;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataTvumpire.updatedAt = updatedAt;
  }
  return fixturesDataTvumpire;
}

Map<String, dynamic> $FixturesDataTvumpireToJson(FixturesDataTvumpire entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['country_id'] = entity.countryId;
...
FixturesDataWinnerteam $FixturesDataWinnerteamFromJson(
    Map<String, dynamic> json) {
  final FixturesDataWinnerteam fixturesDataWinnerteam =
...
Map<String, dynamic> $FixturesDataWinnerteamToJson(
    FixturesDataWinnerteam entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['name'] = entity.name;
...
FixturesDataTosswon $FixturesDataTosswonFromJson(Map<String, dynamic> json) {
  final FixturesDataTosswon fixturesDataTosswon = FixturesDataTosswon();
  final String? resource = jsonConvert.convert<String>(json['resource']);
  if (resource != null) {
    fixturesDataTosswon.resource = resource;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    fixturesDataTosswon.id = id;
  }
  final String? name = jsonConvert.convert<String>(json['name']);
  if (name != null) {
    fixturesDataTosswon.name = name;
  }
  final String? code = jsonConvert.convert<String>(json['code']);
  if (code != null) {
    fixturesDataTosswon.code = code;
  }
  final String? imagePath = jsonConvert.convert<String>(json['image_path']);
  if (imagePath != null) {
    fixturesDataTosswon.imagePath = imagePath;
  }
  final int? countryId = jsonConvert.convert<int>(json['country_id']);
  if (countryId != null) {
    fixturesDataTosswon.countryId = countryId;
  }
  final bool? nationalTeam = jsonConvert.convert<bool>(json['national_team']);
  if (nationalTeam != null) {
    fixturesDataTosswon.nationalTeam = nationalTeam;
  }
  final String? updatedAt = jsonConvert.convert<String>(json['updated_at']);
  if (updatedAt != null) {
    fixturesDataTosswon.updatedAt = updatedAt;
  }
  return fixturesDataTosswon;
}

Map<String, dynamic> $FixturesDataTosswonToJson(FixturesDataTosswon entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['resource'] = entity.resource;
  data['id'] = entity.id;
  data['name'] = entity.name;
...
FixturesMeta $FixturesMetaFromJson(Map<String, dynamic> json) {
  ...
  final List<FixturesMetaLinks>? links =
      jsonConvert.convertListNotNull<FixturesMetaLinks>(json['links']);
  if (links != null) {
